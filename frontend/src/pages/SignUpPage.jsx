...
const SignupPage = () => {
  ...
  return (
    <div
      className="h-screen flex items-center justify-center p-4 sm:p-6 md:p-8" data-theme="garden"
    >
      <div className="border border-primary/25 flex flex-col lg:flex-row w-full max-w-5xl mx-auto bg-slate-100 rounded-xl shadow-lg overflow-hidden">
        {/* LEFT SIDE */}
